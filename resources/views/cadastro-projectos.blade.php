        ...
        <ul id="slide-out" class="sidenav">
                ...
                <div class="row">
                  ...
                  <div class="row">
                     ...
                     <div class="row">
            <p class="col s12 offset-l1 m8 white-text texto-principal" id="texto-principal2">Cadastro de Projectos</p>
        </div>

    </header>

    <div class="container row">
        <h1 class="h1">Cadastro de Projectos</h1>
        <form class="col s12" method="post" action="/cadastro-projectos2" enctype="multipart/form-data">
            @csrf
            <div class="row">

                <div class="input-field col s12">
                    <input type="text" placeholder="Insira o nome do Projecto" id="nome_projecto" name="nome_projecto" required="required">
                    <label for="nome_projecto" class="nome_projecto">Nome do Projecto</label>
                </div>

                <div class="input-field col s12">
                    <textarea id="textarea1" class="materialize-textarea" placeholder="Insira a descrição do Projecto" name="descricao" required="required"></textarea>
                    <label for="textarea1">Descrição</label>
                </div>

                <div class="file-field input-field col s12">
                    <h5>Insira uma Imagem do projecto</h5>
                    <div class="btn">
                        <span>Imagem</span>
                ...
                <div class="file-field input-field col s12">
                    <h5>Insira os arquivos do projecto(.rar ou .zip)</h5>
                    <div class="btn">
                        <span>Arquivo</span>
                           <input type="file" accept=".zip,.rar,.7zip" name="file">
                    </div>
                </div>
                <!--
                <div class="input-field col s12">
                    <select name="curso">
                        <option value="" disabled selected>Selecione o Curso do estudante</option>
...
-->
            ...
            <input type="date" name="date" id="date" class="form-control" required="required">
                ...
                <button class="btn green col offset-l5">Seguinte</button>
            </div>
        </form>
    </div>
