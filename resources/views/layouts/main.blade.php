        ...
        <nav class="indigo">
            <div class="nav-wrapper container">
                ...
                <ul id="" class="right hide-on-med-and-down">
                    ...
                    <li><a href="#sobre" class="tooltipped" data-position="bottom" data-tooltip="Sobre Nôs"><i class="material-icons">info</i></a></li>
                    <li><a href="#servicos" class="tooltipped" data-position="bottom" data-tooltip="Nossos Serviços">Serviços</a></li>
                    <li><a href="#" class="tooltipped" data-position="bottom" data-tooltip="Perguntas Frequentes">FAQs</a></li>
                     @auth
                  <!--aqui-->  <li> 
      ...
      <li><a class="dropdown-trigger" href="#!" data-target="dropdown1">Admin: {{$username}}<i class="material-icons right">arrow_drop_down</i></a></li>
        ...
        <ul id="slide-out" class="sidenav">
                ...
                <div class="row">
                 ...
                 <div class="row">
            <p class="col s12 2 offset-l1 m8 white-text" id="texto-principal">Sobre Nós</p>
        </div>
    </header>
    @yield('content');
